...
#define MAX_PHRASE_OFFSET (NUMBER_DISPLAYS - PHRASE_LENGTH)
#define MAX_ENDING_OFFSET (NUMBER_DISPLAYS - ENDING_LENGTH)
...
#define COUNT_APPEARS (MAX_PHRASE_OFFSET - 1)

#define PHRASE_COUNT_LENGTH (PHRASE_LENGTH + LAGGING_COUNT_OFFSET)
#define PHRASE_COUNT_OFFSET (MAX_PHRASE_OFFSET - LAGGING_COUNT_OFFSET)
