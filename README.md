...
<ul>
    <li><b>Configuration Properties->Debugging->Environment</b> :</br> 
    <em>PATH=%PATH%;$(DAQLocalInstallPath)\bin64;$(DAQGlobalInstallPath)\bin64;$(LocalDebuggerEnvironment)</em></li>
    <li><b>C/C++->General->Additional Include Directories</b> :</br>
    <em>$(SolutionDir)\Scrolling_Display_DAQ\include;$(SolutionDir)\Scrolling_Display_DAQ\src;$(DAQLocalInstallPath)\include;$(DAQGlobalInstallPath)\include;%(AdditionalIncludeDirectories)</em></li>
    <li><b>Linker->General->Additional Library Directories</b> :</br> 
    <em>$(DAQLocalInstallPath)\lib64;$(DAQGlobalInstallPath)\lib64;%(AdditionalLibraryDirectories)</em></li>
</ul>
